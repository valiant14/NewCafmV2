    ...
    <ModalPanel className="max-w-4xl" labelledBy="new-job-request-title">
      ...
      <div className="grid gap-3 overflow-auto px-6 py-4">
        ...
        <div className="mt-5">
          ...
          <label className="relative mt-2 grid min-h-28 cursor-pointer place-items-center content-center gap-1.5 rounded-2xl border border-dashed border-[var(--app-line)] bg-[var(--app-table-header-bg)] p-5 text-center text-[var(--app-muted)]">
            <Upload size={22} />
