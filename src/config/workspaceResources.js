const pageResources = {
  ...
  'Work Orders': ['workOrders', 'assets', 'locations', 'sites', 'departments', 'systems', 'workGroups', 'workOrderWorkflow'],
  ...
  Assets: ['assets', 'locations', 'sites', 'departments', 'systems'],
  ...
  'Routing Masters': ['systems', 'workGroups', 'sites', 'departments', 'labor'],
