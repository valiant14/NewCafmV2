...
export default function OverviewPage({ onNavigate, assets = [], excelDate, failureCodes = [], pmRecords = [], workOrders: liveWorkOrders = [], purchaseRequests = [], purchaseOrders = [], reservations = [] }) {
