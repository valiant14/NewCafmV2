...
function WorkOrderEditor({ order, onClose, page = false }) {
  ...
  return <div className={page?'w-full':'fixed inset-0 z-50 overflow-auto bg-[#112219]/70 p-6 backdrop-blur-sm'}><div className={page?'mx-auto w-full max-w-[1400px] space-y-3 bg-transparent p-0':'mx-auto max-w-7xl space-y-4 rounded-3xl bg-[#fbfcfa] p-0 shadow-2xl'}>
