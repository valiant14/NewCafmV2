...
function WorkOrderEditor({ order, onClose, page = false }) {
  ...
  const status = materialBlocked ? 'Waiting for Spare Parts' : ptwBlocked ? 'Waiting for Permit' : workClosed ? 'CLOSE' : workCompleted ? 'COMP' : overviewReady&&planReady&&failureReady ? 'INPRG' : overviewReady ? 'ASSIGNED' : 'WAPPR'
