...
create table dbo.roles (
  ...
  data_scope nvarchar(30) not null constraint df_roles_data_scope default 'DEPARTMENT',
...
create table dbo.users (
  ...
  data_scope_override nvarchar(30) not null constraint df_users_data_scope_override default 'ROLE',
...
create table dbo.work_orders (
  ...
  closed_by_name nvarchar(160) null,
...
create table dbo.work_order_resource_requests (
  ...
  purchase_request_num nvarchar(80) null,
  purchase_order_num nvarchar(80) null,
  reservation_num nvarchar(80) null,
